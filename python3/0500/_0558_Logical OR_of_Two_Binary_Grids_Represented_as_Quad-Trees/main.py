...
class Solution:
    def intersect(self, quadTree1: 'Node', quadTree2: 'Node') -> 'Node':
        if quadTree1.isLeaf and quadTree2.isLeaf:
            quadTree1.val = max(quadTree1.val, quadTree2.val)
            return quadTree1
            ...
            if quadTree1.topLeft.isLeaf and quadTree1.topRight.isLeaf \
                    and quadTree1.bottomLeft.isLeaf and quadTree1.bottomRight.isLeaf \
                    and quadTree1.topLeft.val == quadTree1.topRight.val == quadTree1.bottomLeft.val == quadTree1.bottomRight.val:
